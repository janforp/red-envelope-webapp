 ...
 */
@Repository
public class ReWithdrawBindDAO extends BaseSqlSessionDaoSupport {
    ...
    public ReWithdrawBind selectByOpen(String openId){
        return getSqlSession().selectOne("re_withdraw_bind.selectByOpen",openId);
    }
