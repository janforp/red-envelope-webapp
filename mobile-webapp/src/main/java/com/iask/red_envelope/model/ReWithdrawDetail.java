...
public class ReWithdrawDetail implements java.io.Serializable {
     ...
     * full constructor
     */
    public ReWithdrawDetail(Integer userId, String withdrawType, String withdrawAccount, String accountName, Integer withdrawStatus, BigDecimal applyMoney, BigDecimal withdrawMoney, String applyTime, String withdrawTime) {
        this.userId = userId;
