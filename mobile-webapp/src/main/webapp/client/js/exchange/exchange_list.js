        ...
        success :   function(data){
            ...
            if (data.code == 0) {
                ...
                for (var i= 0;i<vos.length;i ++) {
                    ...
                    newTbody +=
                    "<a href='/c/p/exchange/detail/"+id+"'>" +
                        "<div class='oneLine'>"+
                        " <div class ='lineLeft'>"+
                            "<span class='leftSpan1'>"+vos[i].goodsName+"</span>"+
                            "<span class='leftSpan2'>"+vos[i].score+"金币</span>"+
                            "</div>"+
                            "<div class='lineRight'>"+
                            "<span class='rightSpan1'>"+vos[i].exchangeTime+"</span>"+
                            "<span class='rightSpan2'>";
                            if(vos[i].exchangeStatus == '0'){
                                newTbody += "审核中";
                            }else if(vos[i].exchangeStatus == '1'){
                                newTbody += "已完成";
                            }else if(vos[i].exchangeStatus == '2'){
                                newTbody += "已作废";
                            }
                    newTbody +=
                            "</span>"+
