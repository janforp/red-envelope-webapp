...
<body>
    <div class="content">
        <div id="cover" style="width: 100%;height: 100%;background-color: #7F7F7F;position: absolute;top: 0;left: 0;alpha(opacity=70); opacity: 0.7;display: none"></div>
        <div class="headerDiv">
        ...
        <div class="footButtonDiv">
            <button onclick="alertInvite();" id="invite"><span>立即邀请好友</span></button>
        </div>
        <div class="ruleTitle">
    ...
    <div class="fixFootButtonDiv">
        <%@include file="invitate.jsp"%>
    </div>
</body>
</html>