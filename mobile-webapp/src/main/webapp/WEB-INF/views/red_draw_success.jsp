        ...
        <div class="container" id="container">
            <div class="redTop">
                <div style="margin-top: 1rem;">
                    <%--<span style="color: #FFBC3C; font-size: 1.2rem;">领取成功!</span>--%>
                </div>
            </div>
            <div class="headImg">
                <img src="${customerImg}">
            ...
            <div class="content">
                <div>
                    <span style="color: #000000; font-size: 1.0rem;">来自${customerName}的微信红包</span><br>
                </div>
                <div style="margin-top: 0.5rem">
                    <span style="color: #9e9e9e; font-size: 0.8rem;">持续关注${customerName},获得更多红包</span><br>
                </div>
                <div style="margin-top: 1.5rem">
                    <span style="font-size: 3.0rem;">¥${money}</span><br>
                </div>
                <c:if test="${customerAdvert != null}">
                    <div class="advert">
                        <a href="${customerAdvertUrl}">
                            <img src="${customerAdvert}">
                        </a>
                    </div>
                </c:if>
