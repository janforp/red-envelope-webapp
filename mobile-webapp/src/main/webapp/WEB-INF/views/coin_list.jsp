<head>
    ...
    <script src="/client/js/coin_list.js"></script>
    <!--无法分享组件-->
    ...
    <div id="wrapper">
        <div id="scroller">
            <div class="content">
                ...
                <div class="record">
                    <div class="record1">
                        <a href="/c/p/exchange/exchangeList"><img src="/client/img/coinmall/record.png"><span>兑换记录</span></a>
                    </div>
                    <div class="record2">
                    ...
                    <c:forEach items="${scores}" var="score">
                            <div class="oneLine">
                                <div class ="lineLeft">
                                    ...
                                    <span class="leftSpan2">${score.scoreContent}</span>
                                </div>
                                <div class="lineRight">
                                    <span class="rightSpan1">${score.scoreTime}</span>
                                    <span class="rightSpan2">
                                        <c:if test="${score.scoreType == 0}">
                                            - ${score.score}
                                        </c:if>
